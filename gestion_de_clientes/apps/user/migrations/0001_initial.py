    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CLIENTE', 'Cliente'), ('CONTADOR', 'Contador')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contador_id', models.UUIDField(blank=True, default=uuid.uuid4)),
        ...
        migrations.CreateModel(
            ...
            bases=('user.user',),
            managers=[
                ('contador', django.db.models.manager.Manager()),
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
    ]
