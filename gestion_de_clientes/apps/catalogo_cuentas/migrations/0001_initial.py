    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.UUIDField(blank=True, default=uuid.UUID('b1944645-c116-46de-afb4-241e1d127385'))),
                ('contador', models.UUIDField(blank=True, default=uuid.UUID('1bceeb98-7921-4914-b998-bc093dbc1ad7'))),
