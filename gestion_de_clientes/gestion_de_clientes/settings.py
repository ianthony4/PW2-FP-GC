"""
Django settings for gestion_de_clientes project.
...
SECRET_KEY = 'django-insecure-(b%@h#fj8$x3&@b8(e60j0x^7u88%zg433*l!h&ikk#!!glr(f'
...
ROOT_URLCONF = 'gestion_de_clientes.urls'
...
WSGI_APPLICATION = 'gestion_de_clientes.wsgi.application'
